...
export interface Config {
  ...
  globalsSelect: {
    LandingNav: LandingNavSelect<false> | LandingNavSelect<true>;
    PatientNav: PatientNavSelect<false> | PatientNavSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "PatientNav".
 */
export interface PatientNav {
  id: string;
  items?:
    | {
        name: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LandingNav_select".
 */
export interface LandingNavSelect<T extends boolean = true> {
  items?:
    | T
    | {
        name?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "PatientNav_select".
 */
export interface PatientNavSelect<T extends boolean = true> {
  items?:
    | T
    | {
        name?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "DoctorNav_select".
 */
export interface DoctorNavSelect<T extends boolean = true> {
  items?:
    | T
    | {
        name?: T;
