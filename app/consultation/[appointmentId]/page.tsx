...
import { getMsgsByAppointment } from "@/lib/actions/message.actions";
...
export default async function page({
	...
	const appointmentMsgs = await getMsgsByAppointment({
	...
	// console.log("MSGS: ", appointmentMsgs);
