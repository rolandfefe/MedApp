	...
	return (
		<DrawerPortal data-slot="drawer-portal">
			...
			<DrawerPrimitive.Content
				...
				className={cn(
					"group/drawer-content glass-bg fixed z-50 flex h-auto flex-col",
			...
			>
				<div
					className={cn(
						"cursor-grab bg-secondary/80 dark:bg-muted/40 backdrop-blur-md mx-auto mt-4 h-2 w-[100px] shrink-0 rounded-full",
